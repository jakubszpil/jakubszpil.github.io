import{H as e,L as t,c as n,m as r,p as i,s as a,t as o,u as s}from"./jsx-runtime-DMawWLDI.js";import{c,o as l}from"./src-DJwQwobt.js";import{n as u,t as d}from"./scroll-restoration-qMssALf9.js";var f=`/assets/styles-19OhZb-H.css`,p=e(o(),1);function m({children:e}){return(0,p.jsxs)(`html`,{lang:`pl`,"data-timestamp":1768824311480,children:[(0,p.jsxs)(`head`,{children:[(0,p.jsx)(`meta`,{charSet:`utf-8`}),(0,p.jsx)(`meta`,{name:`viewport`,content:`width=device-width, initial-scale=1`}),(0,p.jsx)(`link`,{rel:`icon`,href:`/favicon.svg`,sizes:`any`,type:`image/svg+xml`}),(0,p.jsx)(`link`,{rel:`preload`,as:`style`,href:f}),(0,p.jsx)(`link`,{rel:`stylesheet`,href:f}),(0,p.jsx)(`link`,{rel:`preload prefetch`,href:`/fonts/geist.ttf`,as:`font`,type:`font/ttf`,crossOrigin:`anonymous`}),(0,p.jsx)(c,{code:`
            let k = "theme";
            let t = "dark";
            let s = localStorage;
