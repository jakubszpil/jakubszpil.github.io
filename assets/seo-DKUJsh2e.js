import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{a as s,x as w}from"./chunk-ZYFC6VSF-Br-XelTp.js";/**
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const u=(e,c,i,n)=>{const a=s.forwardRef(({color:p="currentColor",size:o=24,stroke:r=2,title:d,className:h,children:l,...k},j)=>s.createElement("svg",{ref:j,...b[e],width:o,height:o,className:["tabler-icon",`tabler-icon-${c}`,h].join(" "),strokeWidth:r,stroke:p,...k},[d&&s.createElement("title",{key:"svg-title"},d),...n.map(([g,y])=>s.createElement(g,y)),...Array.isArray(l)?l:[l]]));return a.displayName=`${i}`,a};/**
 * @license @tabler/icons-react v3.17.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
